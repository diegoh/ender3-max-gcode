...
#define STRING_CONFIG_H_AUTHOR "@diegoh" // Who made the changes.
...
#define XY_PROBE_FEEDRATE 12000 // default (133 * 60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (10 * 60) // default (4 * 60)
...
#define DELAY_BEFORE_PROBING 100 // (ms) To prevent vibrations from triggering piezo sensors - default 200
...
#define DEFAULT_LEVELING_FADE_HEIGHT 0 // (mm) Default fade height. // default 10.0
#endif
...
#define MESH_TEST_HOTEND_TEMP 210  // (°C) Default nozzle temperature for G26. // default 205
...
#define BED_CENTER_AT_150_150 // default BED_CENTER_AT_0_0
...
#define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE) / 2) // default X_CENTER // X point for Z homing
#define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE) / 2) // default Y_CENTER // Y point for Z homing
#endif
